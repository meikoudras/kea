    ...
    value: function init() {
      ...
      if ((typeof response === 'undefined' ? 'undefined' : _typeof(response)) === 'object') {
        ...
        for (var i = 0; i < keys.length; i++) {
          ...
          object.selectors[keys[i]] = _reselect.createSelector.apply(undefined, _toConsumableArray(args).concat([s[1]]));
        }
      }
